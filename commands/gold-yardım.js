//---Buda gold üye değilsin komut kullanamassın kullanmak isteyenler için. 
   ...
   await fetch(
    ...
    .then(json => {
      ...
      const embed = new Discord.MessageEmbed()
        .setAuthor("Türkiyede Yaşanan Son 10 Deprem!")
        .setColor("#728bd6")
        .setThumbnail(
...
exports.help = {
  name: 'gghazal', 
  description: "Gold Yardım Menüsünü Gösterir",
  usage: 'gyardım'
};