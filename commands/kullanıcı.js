...
**Darkness Claw ile kurmuş olduğunuz ayarlarınızı sıfırlayarak sunucundan çıkar

🏥 \`${client.ayarlar.prefix}deprembilgi\`
Türkiyede Yaşanan Son 10 Depremin Bilgisini Atar!

**`).setThumbnail('https://media.giphy.com/media/3qXi5eIvcgCmTDObOU/giphy.gif'));
