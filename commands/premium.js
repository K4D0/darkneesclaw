...
let skorsky = require('./skorsky.json');
exports.run = async (client, message, args) => {
  ////--------------------------------------------\\\\       
  let prefix = skorsky.prefix
  let sahip = '515589379704487936' //Premium verebilicek / alabilecek kişiler
  let log = client.channels.cache.get('810212989185294366') // logların tutulcağı kanal
  ////--------------------------------------------\\\\     
