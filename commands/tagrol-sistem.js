...
.setColor('#000001')
.setTitle('Darkness Claw Tag Rol & Kanal')
...
**Buradaki herşeyi kurduktan sonra, \`Tag\` alan veya çıkartanın sunucunuz da herhangi bir kanala msj yazması durumunda alıp vermektedir.**
`)
