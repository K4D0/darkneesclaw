...
let images = ['', ''];
message.channel.send(new Discord.MessageEmbed().setColor('#000001').setDescription(`**Fynx Kullanırken rolünü en yukarıda tutunuz.**
...
**💸 İninal Barkod NO: \`❌Kullanılmıyor\`
💸 Papara Hesap NO: \`Eklenecek\`
